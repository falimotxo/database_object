...
class DatabaseConfigModule(object):
    """
    ...
    def __init__(self) -> None:
        ...
        # Logging config
        logging.config.fileConfig(DatabaseConfigModule.CONFIG_LOGGING_FULL_PATH)
        for h in logging.root.handlers:
            h.setFormatter(CustomFormatter(h.formatter))

        # Config file
        self.config = configparser.ConfigParser()
        self.config.read(DatabaseConfigModule.CONFIG_FILE_FULL_PATH)
    ...
    def get_value(self, key: str, section: str = 'DEFAULT') -> str:
        ...
        try:
            ...
            raise DatabaseObjectException(ErrorMessages.KEYFILE_ERROR)